...
const PrivacyPolicy = () => {
  ...
  return (
    ...
    >
      <Link
        to='/'
        className='relative inline-flex items-center justify-start px-5 py-3 overflow-hidden font-normal rounded-lg group mb-8'
      >
      ...
      <div className={`flex flex-col gap-4 md:gap-8`}>
        ...
        <Typography
          variant='paragraph'
          className='font-rubik text-justify font-bold'
        >
        ...
        <Typography
          variant='paragraph'
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          <span className='font-normal'>Account</span> means a unique account
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          <span className='font-normal'>Affiliate</span> means an entity that
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          <span className='font-normal'>Company</span> (referred to as either
          "the Company", "We", "Us" or "Our" in this Agreement) refers to Sole
          proprieter, Pune, Maharashtra.
        </Typography>
        <Typography
          variant='paragraph'
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          <span className='font-normal'>Cookies</span> are small files that are
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          <span className='font-normal'>Country</span> refers to: Maharashtra,
          India
        </Typography>
        <Typography
          variant='paragraph'
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          <span className='font-normal'>Device</span> means any device that can
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          <span className='font-normal'>Personal Data</span> is any information
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          <span className='font-normal'>Service</span> refers to the Website.
        </Typography>
        <Typography
          variant='paragraph'
          className='font-rubik text-justify pl-5 md:pl-10'
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          <span className='font-normal'>Third-party Social Media Service </span>
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          <span className='font-normal'>Usage Data </span>
        ...
        >
          ...
          refers to maitra solar solutions, accessible from
          www.maitrasolarsolutions.in
        </Typography>
        <Typography
          variant='paragraph'
          className='font-rubik text-justify pl-5 md:pl-10'
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          • <span className='font-normal'>Cookies or Browser Cookies.</span> A
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          • <span className='font-normal'>Web Beacons.</span> Certain sections
          of our Service and our emails may contain small electronic files known
        ...
        <Typography
          variant='paragraph'
          className='font-rubik text-justify font-bold pl-5 md:pl-10'
        >
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          <span className='font-normal'>To manage Your Account:</span> to manage
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          <span className='font-normal'>To contact You:</span> To contact You by
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          <span className='font-normal'>To provide You with news,</span> special
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          <span className='font-normal'>To manage Your requests:</span> To
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          <span className='font-normal'>For business transfers:</span> We may
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          <span className='font-normal'>For other purposes:</span> We For other
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          • <span className='font-normal'>With Service Providers:</span> We may
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          • <span className='font-normal'>With Affiliates:</span> We may share
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          • <span className='font-normal'>With business partners:</span> We may
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          • <span className='font-normal'>With other users:</span> when You
        ...
        <Typography
          ...
          className='font-rubik text-justify pl-5 md:pl-10'
        >
          • <span className='font-normal'>With Your consent:</span> We may
